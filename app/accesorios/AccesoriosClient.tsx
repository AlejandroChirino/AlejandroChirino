...
function AccessoriesProducts({
  ...
  if (products.length === 0) return (
    <div className="text-center text-gray-500 py-16">
      ...
      <p className="mb-6">Estamos preparando una increíble colección de accesorios</p>
    </div>
  )
...
export default function AccesoriosClient() {
  ...
  return (
    <div>
      <Breadcrumbs items={[{ label: "accesorios", href: "/accesorios" }, ...(selectedSubcategory ? [{ label: selectedSubcategory }] : [])]} className="mb-2 px-4 md:px-6 -mt-4 md:-mt-6" />
